...
export default function HomePage() {
  ...
  return (
    <>
      <section
        id="hero"
        className="min-h-[80vh] md:h-screen max-h-[1100px] bg-gradient-to-b from-blue-100 to-white overflow-y-clip"
      >
        <div className="container h-full w-full flex items-center justify-center flex-col text-center">
          <h6 className="capitalize text-primary mb-10">
            {homePageData.eyebrow}
          </h6>
          {/* SỬA: text-h4 (Mobile/Tablet) -> lg:text-h1 (Desktop) */}
          <h1 className="mx-auto max-w-6xl capitalize pb-3">
            {homePageData.title}
          </h1>
          <div className="flex items-center justify-center ">
            <Button size="md" href={homePageData.ctaButton.link || undefined}>
      ...
      <section className="mx-auto py-10">
        <div className="container bg-ink rounded-2xl p-10 mb-5">
          <div className="text-center ">
            {/* SỬA: text-h5 (Mobile/Tablet) -> lg:text-h2 (Desktop) */}
            <h2 className=" text-white mb-5">{solutionSection.title}</h2>
      ...
      <section className="container py-10">
        <div className="text-center">
          ...
          {/* SỬA: text-h5 (Mobile/Tablet) -> lg:text-h2 (Desktop) */}
          <h2 className="mb-15 text-black hidden md:block ">{featureSection.description}</h2>
        </div>
      ...
      <section className="relative overflow-hidden bg-ink">
        <div className="container mx-auto">
          <div className="text-center">
            ...
            <h2 className="mb-15 text-white hidden md:block ">{experienceSection.title}</h2>
          </div>
      ...
      <section className="py-10 bg-white">
        <div className="container">
          ...
          <div className="mt-8 flex flex-col items-center justify-between gap-4 md:flex-row ">
            ...
            {/* View All Link */}
            {/* SỬA: text-sm (Tablet) -> lg:text-sub2 (Desktop) */}
            <Link
              href="/blog/blog-home"
          ...
          {/* Post Grid (Đã đúng, không cần sửa) */}
          <div className="mt-10 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {blogPosts && blogPosts.length > 0 ? (
              blogPosts.map((post, index) => (
                <article
