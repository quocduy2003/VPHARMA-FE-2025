...
// // --- MOCK DATA (Dữ liệu mẫu mặc định) ---
...
// // --- PROPS CỦA TRANG ACCOUNT ---
// // Sửa lỗi: Đánh dấu các props là optional (?) để tránh lỗi khi không truyền
...
//       {/* SỬA LỖI INPUT: Thêm aria-label hoặc title để fix lỗi Accessibility */}
//       <input 
//         type="file" 
//         ref={fileInputRef} 
//         className="hidden" 
...
//       <div className="container mx-auto max-w-6xl grid grid-cols-1 gap-8 lg:grid-cols-3">
...
//                 {/* Đổi mật khẩu */}
//                 <div className="col-span-1 md:col-span-2 pt-4 border-t border-black">
