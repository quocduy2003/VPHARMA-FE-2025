                        ...
                        <article className="col-span-1 lg:col-span-8 ">
                            ...
                            <div>
                                <div className="rounded-lg flex flex-row my-8">
                                    <h3 className="text-sub1 font-bold mr-5">Chia sẻ bài viết:</h3>
                            ...
                            <div className="author-info rounded-lg mt-2 p-6 border flex flex-col border-dashed border-primary bg-blue-50">
                                ...
                                <div className="flex flex-row gap-6 items-center ">
                                    ...
                                    <div className="">
                                        ...
                                        <div className="font-bold text-primary text-lg mb-1">PHẠM THU A</div>
                                        <div className="italic text-sm text-gray-500 mb-1">Biên tập viên</div>
                                    </div>
