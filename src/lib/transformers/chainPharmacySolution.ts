...
export function transformChainPharmacyData(response: any): ChainPharmacyData {
  ...
  return {
    ...
    pharmacyChainChallengesSection: {
      ...
      challengeCards: Array.isArray(pharmacyChainChallengesSection?.challengeCards)
    ...
    featureBenefitsSection: {
      ...
      contents: Array.isArray(featureBenefitsSection?.contents)
    ...
    operationsStandardizationSection: {
      ...
      contents: Array.isArray(operationsStandardizationSection?.contents)
    ...
    customerExperienceSection: {
      ...
      cards: Array.isArray(customerExperienceSection?.cards)
    ...
    featureOverview: {
      ...
      contentCards: Array.isArray(featureOverview?.contentCards)
    ...
    featureCarousel: {
      ...
      featureImages: Array.isArray(featureCarousel?.featureImages)
    ...
    operationsStandardizationBottomSection: {
      ...
      title:
        ...
        "Đồng bộ quy trình vận hành cho chuỗi nhà thuốc",
      contents: Array.isArray(operationsStandardizationBottomSection?.contents)
    ...
    pharmaFeedback: {
      ...
      cards: Array.isArray(pharmaFeedback?.cards)
